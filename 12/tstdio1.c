...
{ /* test vprintf */
    va_list ap;
    va_start(ap,vprintf(f.mt,va _end (ap) ;
    vprintf(fmt, ap);
    va_end(ap);
}
...
assert(strcmp(buf, "a|-4 |OO1O|OXC" ) == 0);
