...
int main()
{
    /* test basic properties of limite.h macros */
    printf("CHAR_BIT = %2i MB LEN MAX= %2i\n\n", CHAR_BIT, MB_LEN_MAX);
    printf("CHAR_MAX = %10i CHAR MIN= %10i\n", CHAR_MAX, CHAR_MIN);
    printf("SCHAR_MAX = %10i SCHAR MIN = %10i \n", SCHAR_MAX, SCHAR_MIN);
    printf("UCHAR_MAX = %10u\n\n", UCHAR_MAX);
    printf("SHRT_MAX = %10i SHRT_MIN = %10i \n", SHRT_MAX, SHRT_MIN);
    printf("USHRT_MAX = %10u\n\n", USHRT_MAX);
    printf("INT MAX = %10i INT_MIN = %10i \n", INT_MAX, INT_MIN);
    printf("UINT_MAX = %10u\n\n", UINT_MAX);
    printf("LONG_MAX = %10li LONG_M:IN = %10li \n", LONG_MAX, LONG_MIN);
